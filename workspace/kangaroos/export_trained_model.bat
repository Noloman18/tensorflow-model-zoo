...
python research\object_detection\export_inference_graph.py --input_type image_tensor --pipeline_config_path=workspace/kangaroos/pipeline/ssd_mobilenet_v1_coco_v1_1_class.config --trained_checkpoint_prefix=%TRAINED_CHECKPOINT% --output_directory=%OUTPUT_DIRECTORY%
